...
<div>
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <div class="grid-container">
            <c:forEach var="singleEntry" items="${exerciseEntries}">

                <div class="grid-item ${singleEntry.type}" >
                    <span>${singleEntry.type} </span>
                    <span>${singleEntry.duration} </span>
                    <span>${singleEntry.notes} </span>
                </div>
